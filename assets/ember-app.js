...
define('ember-app/enums/i-i-s-proekt-invoice-status', ['exports', 'ember-flexberry-data/utils/enum-functions'], function (exports, _enumFunctions) {
  'use strict';
...
define('ember-app/enums/i-i-s-proekt-order-status', ['exports', 'ember-flexberry-data/utils/enum-functions'], function (exports, _enumFunctions) {
  'use strict';
...
define('ember-app/enums/i-i-s-proekt-position-list', ['exports', 'ember-flexberry-data/utils/enum-functions'], function (exports, _enumFunctions) {
  'use strict';
...
define('ember-app/locales/en/models/i-i-s-proekt-document', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/models/i-i-s-proekt-employee', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/models/i-i-s-proekt-invoice-item', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/models/i-i-s-proekt-invoice', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/models/i-i-s-proekt-order-item', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/models/i-i-s-proekt-order', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/models/i-i-s-proekt-product', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/models/i-i-s-proekt-store-product', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/models/i-i-s-proekt-storehouse', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/en/translations', ['exports', 'ember-flexberry/locales/en/translations', 'ember-app/locales/en/models/i-i-s-proekt-document', 'ember-app/locales/en/models/i-i-s-proekt-employee', 'ember-app/locales/en/models/i-i-s-proekt-invoice-item', 'ember-app/locales/en/models/i-i-s-proekt-invoice', 'ember-app/locales/en/models/i-i-s-proekt-order-item', 'ember-app/locales/en/models/i-i-s-proekt-order', 'ember-app/locales/en/models/i-i-s-proekt-product', 'ember-app/locales/en/models/i-i-s-proekt-store-product', 'ember-app/locales/en/models/i-i-s-proekt-storehouse'], function (exports, _translations, _iISProektDocument, _iISProektEmployee, _iISProektInvoiceItem, _iISProektInvoice, _iISProektOrderItem, _iISProektOrder, _iISProektProduct, _iISProektStoreProduct, _iISProektStorehouse) {
  'use strict';
  ...
  Ember.$.extend(true, translations, {
    models: {
      'i-i-s-proekt-document': _iISProektDocument.default,
      'i-i-s-proekt-employee': _iISProektEmployee.default,
      'i-i-s-proekt-invoice-item': _iISProektInvoiceItem.default,
      'i-i-s-proekt-invoice': _iISProektInvoice.default,
      'i-i-s-proekt-order-item': _iISProektOrderItem.default,
      'i-i-s-proekt-order': _iISProektOrder.default,
      'i-i-s-proekt-product': _iISProektProduct.default,
      'i-i-s-proekt-store-product': _iISProektStoreProduct.default,
      'i-i-s-proekt-storehouse': _iISProektStorehouse.default
    },
...
define('ember-app/locales/ru/models/i-i-s-proekt-document', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/models/i-i-s-proekt-employee', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/models/i-i-s-proekt-invoice-item', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/models/i-i-s-proekt-invoice', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/models/i-i-s-proekt-order-item', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/models/i-i-s-proekt-order', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/models/i-i-s-proekt-product', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/models/i-i-s-proekt-store-product', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/models/i-i-s-proekt-storehouse', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/locales/ru/translations', ['exports', 'ember-flexberry/locales/ru/translations', 'ember-app/locales/ru/models/i-i-s-proekt-document', 'ember-app/locales/ru/models/i-i-s-proekt-employee', 'ember-app/locales/ru/models/i-i-s-proekt-invoice-item', 'ember-app/locales/ru/models/i-i-s-proekt-invoice', 'ember-app/locales/ru/models/i-i-s-proekt-order-item', 'ember-app/locales/ru/models/i-i-s-proekt-order', 'ember-app/locales/ru/models/i-i-s-proekt-product', 'ember-app/locales/ru/models/i-i-s-proekt-store-product', 'ember-app/locales/ru/models/i-i-s-proekt-storehouse'], function (exports, _translations, _iISProektDocument, _iISProektEmployee, _iISProektInvoiceItem, _iISProektInvoice, _iISProektOrderItem, _iISProektOrder, _iISProektProduct, _iISProektStoreProduct, _iISProektStorehouse) {
  'use strict';
...
define('ember-app/mixins/regenerated/models/i-i-s-proekt-document', ['exports', 'ember-data', 'ember-cp-validations'], function (exports, _emberData, _emberCpValidations) {
  'use strict';
...
define('ember-app/mixins/regenerated/models/i-i-s-proekt-employee', ['exports', 'ember-data', 'ember-cp-validations'], function (exports, _emberData, _emberCpValidations) {
  'use strict';
  ...
  var Model = exports.Model = Ember.Mixin.create({
    ...
    position: _emberData.default.attr('i-i-s-proekt-position-list')
  });
...
define('ember-app/mixins/regenerated/models/i-i-s-proekt-invoice-item', ['exports', 'ember-data', 'ember-cp-validations'], function (exports, _emberData, _emberCpValidations) {
  'use strict';
  ...
  var Model = exports.Model = Ember.Mixin.create({
    ...
    product: _emberData.default.belongsTo('i-i-s-proekt-product', { inverse: null, async: false }),
    invoice: _emberData.default.belongsTo('i-i-s-proekt-invoice', { inverse: 'invoiceItem', async: false })
  });
...
define('ember-app/mixins/regenerated/models/i-i-s-proekt-invoice', ['exports', 'ember-data', 'ember-cp-validations', 'ember-app/enums/i-i-s-proekt-invoice-status'], function (exports, _emberData, _emberCpValidations, _iISProektInvoiceStatus) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.defineBaseModel = exports.ValidationRules = exports.Model = undefined;
  var Model = exports.Model = Ember.Mixin.create({
    customerName: _emberData.default.attr('string'),
    note: _emberData.default.attr('string'),
    shipmentDateTime: _emberData.default.attr('date'),
    status: _emberData.default.attr('i-i-s-proekt-invoice-status', { defaultValue: _iISProektInvoiceStatus.default.New }),
    totalSum: _emberData.default.attr('decimal'),
    totalWeight: _emberData.default.attr('decimal'),
    employee: _emberData.default.belongsTo('i-i-s-proekt-employee', { inverse: null, async: false }),
    order: _emberData.default.belongsTo('i-i-s-proekt-order', { inverse: null, async: false }),
    invoiceItem: _emberData.default.hasMany('i-i-s-proekt-invoice-item', { inverse: 'invoice', async: false })
  });
...
define('ember-app/mixins/regenerated/models/i-i-s-proekt-order-item', ['exports', 'ember-data', 'ember-cp-validations'], function (exports, _emberData, _emberCpValidations) {
  'use strict';
  ...
  var Model = exports.Model = Ember.Mixin.create({
    ...
    totalSum: _emberData.default.attr('decimal'),
    product: _emberData.default.belongsTo('i-i-s-proekt-product', { inverse: null, async: false }),
    order: _emberData.default.belongsTo('i-i-s-proekt-order', { inverse: 'orderItem', async: false })
  });
...
define('ember-app/mixins/regenerated/models/i-i-s-proekt-order', ['exports', 'ember-data', 'ember-cp-validations', 'ember-app/enums/i-i-s-proekt-order-status'], function (exports, _emberData, _emberCpValidations, _iISProektOrderStatus) {
  'use strict';
  ...
  var Model = exports.Model = Ember.Mixin.create({
    ...
    status: _emberData.default.attr('i-i-s-proekt-order-status', { defaultValue: _iISProektOrderStatus.default.New }),
    /**
      Non-stored property.
       @property totalSum
    */
    ...
    */
    ...
    employee: _emberData.default.belongsTo('i-i-s-proekt-employee', { inverse: null, async: false }),
    orderItem: _emberData.default.hasMany('i-i-s-proekt-order-item', { inverse: 'order', async: false })
  });
...
define('ember-app/mixins/regenerated/models/i-i-s-proekt-product', ['exports', 'ember-data', 'ember-cp-validations'], function (exports, _emberData, _emberCpValidations) {
  'use strict';
...
define('ember-app/mixins/regenerated/models/i-i-s-proekt-store-product', ['exports', 'ember-data', 'ember-cp-validations'], function (exports, _emberData, _emberCpValidations) {
  'use strict';
  ...
  var Model = exports.Model = Ember.Mixin.create({
    amount: _emberData.default.attr('number'),
    product: _emberData.default.belongsTo('i-i-s-proekt-product', { inverse: null, async: false }),
    storehouse: _emberData.default.belongsTo('i-i-s-proekt-storehouse', { inverse: 'storeProduct', async: false })
  });
...
define('ember-app/mixins/regenerated/models/i-i-s-proekt-storehouse', ['exports', 'ember-data', 'ember-cp-validations'], function (exports, _emberData, _emberCpValidations) {
  'use strict';
  ...
  var Model = exports.Model = Ember.Mixin.create({
    ...
    number: _emberData.default.attr('number', { defaultValue: 1 }),
    employee: _emberData.default.belongsTo('i-i-s-proekt-employee', { inverse: null, async: false }),
    storeProduct: _emberData.default.hasMany('i-i-s-proekt-store-product', { inverse: 'storehouse', async: false })
  });
...
define('ember-app/mixins/regenerated/serializers/i-i-s-proekt-document-offline', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-proekt-document', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-proekt-employee-offline', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-proekt-employee', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-proekt-invoice-item-offline', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-proekt-invoice-item', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-proekt-invoice-offline', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-proekt-invoice', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-proekt-order-item-offline', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-proekt-order-item', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-proekt-order-offline', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-proekt-order', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-proekt-product-offline', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-proekt-product', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-proekt-store-product-offline', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-proekt-store-product', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-proekt-storehouse-offline', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/mixins/regenerated/serializers/i-i-s-proekt-storehouse', ['exports'], function (exports) {
  'use strict';
...
define('ember-app/models/i-i-s-proekt-document', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-app/mixins/regenerated/models/i-i-s-proekt-document'], function (exports, _emberCpValidations, _model, _iISProektDocument) {
  'use strict';
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_iISProektDocument.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_iISProektDocument.Model, Validations, {});

  exports.default = Model;
});
define('ember-app/models/i-i-s-proekt-employee', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-app/mixins/regenerated/models/i-i-s-proekt-employee'], function (exports, _emberCpValidations, _model, _iISProektEmployee) {
  'use strict';
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_iISProektEmployee.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_iISProektEmployee.Model, Validations, {});

  exports.default = Model;
});
define('ember-app/models/i-i-s-proekt-invoice-item', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-app/mixins/regenerated/models/i-i-s-proekt-invoice-item'], function (exports, _emberCpValidations, _model, _iISProektInvoiceItem) {
  'use strict';
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_iISProektInvoiceItem.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_iISProektInvoiceItem.Model, Validations, {});

  exports.default = Model;
});
define('ember-app/models/i-i-s-proekt-invoice', ['exports', 'ember-cp-validations', 'ember-app/mixins/regenerated/models/i-i-s-proekt-invoice', 'ember-app/models/i-i-s-proekt-document', 'ember-app/mixins/regenerated/models/i-i-s-proekt-document'], function (exports, _emberCpValidations, _iISProektInvoice, _iISProektDocument, _iISProektDocument2) {
  'use strict';
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(Ember.$.extend({}, _iISProektDocument2.ValidationRules, _iISProektInvoice.ValidationRules), {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _iISProektDocument.default.extend(_iISProektInvoice.Model, Validations, {});

  (0, _iISProektInvoice.defineBaseModel)(Model);

  exports.default = Model;
});
define('ember-app/models/i-i-s-proekt-order-item', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-app/mixins/regenerated/models/i-i-s-proekt-order-item'], function (exports, _emberCpValidations, _model, _iISProektOrderItem) {
  'use strict';
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_iISProektOrderItem.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_iISProektOrderItem.Model, Validations, {});

  exports.default = Model;
});
define('ember-app/models/i-i-s-proekt-order', ['exports', 'ember-cp-validations', 'ember-app/mixins/regenerated/models/i-i-s-proekt-order', 'ember-app/models/i-i-s-proekt-document', 'ember-app/mixins/regenerated/models/i-i-s-proekt-document'], function (exports, _emberCpValidations, _iISProektOrder, _iISProektDocument, _iISProektDocument2) {
  'use strict';
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(Ember.$.extend({}, _iISProektDocument2.ValidationRules, _iISProektOrder.ValidationRules), {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _iISProektDocument.default.extend(_iISProektOrder.Model, Validations, {});

  (0, _iISProektOrder.defineBaseModel)(Model);

  exports.default = Model;
});
define('ember-app/models/i-i-s-proekt-product', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-app/mixins/regenerated/models/i-i-s-proekt-product'], function (exports, _emberCpValidations, _model, _iISProektProduct) {
  'use strict';
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_iISProektProduct.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_iISProektProduct.Model, Validations, {});

  exports.default = Model;
});
define('ember-app/models/i-i-s-proekt-store-product', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-app/mixins/regenerated/models/i-i-s-proekt-store-product'], function (exports, _emberCpValidations, _model, _iISProektStoreProduct) {
  'use strict';
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_iISProektStoreProduct.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_iISProektStoreProduct.Model, Validations, {});

  exports.default = Model;
});
define('ember-app/models/i-i-s-proekt-storehouse', ['exports', 'ember-cp-validations', 'ember-flexberry-data/models/model', 'ember-app/mixins/regenerated/models/i-i-s-proekt-storehouse'], function (exports, _emberCpValidations, _model, _iISProektStorehouse) {
  'use strict';
  ...
  var Validations = (0, _emberCpValidations.buildValidations)(_iISProektStorehouse.ValidationRules, {
    dependentKeys: ['model.i18n.locale']
  });

  var Model = _model.default.extend(_iISProektStorehouse.Model, Validations, {});
...
define('ember-app/serializers/i-i-s-proekt-document-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-proekt-document-offline', 'ember-app/serializers/application-offline'], function (exports, _iISProektDocumentOffline, _applicationOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _applicationOffline.default.extend(_iISProektDocumentOffline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-proekt-document', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-proekt-document', 'ember-app/serializers/application'], function (exports, _iISProektDocument, _application) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _application.default.extend(_iISProektDocument.Serializer, {
    /**
...
define('ember-app/serializers/i-i-s-proekt-employee-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-proekt-employee-offline', 'ember-app/serializers/application-offline'], function (exports, _iISProektEmployeeOffline, _applicationOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _applicationOffline.default.extend(_iISProektEmployeeOffline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-proekt-employee', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-proekt-employee', 'ember-app/serializers/application'], function (exports, _iISProektEmployee, _application) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _application.default.extend(_iISProektEmployee.Serializer, {
    /**
    * Field name where object identifier is kept.
    */
    primaryKey: '__PrimaryKey'
...
define('ember-app/serializers/i-i-s-proekt-invoice-item-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-proekt-invoice-item-offline', 'ember-app/serializers/application-offline'], function (exports, _iISProektInvoiceItemOffline, _applicationOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _applicationOffline.default.extend(_iISProektInvoiceItemOffline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-proekt-invoice-item', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-proekt-invoice-item', 'ember-app/serializers/application'], function (exports, _iISProektInvoiceItem, _application) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _application.default.extend(_iISProektInvoiceItem.Serializer, {
    /**
    * Field name where object identifier is kept.
    */
    primaryKey: '__PrimaryKey'
...
define('ember-app/serializers/i-i-s-proekt-invoice-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-proekt-invoice-offline', 'ember-app/serializers/i-i-s-proekt-document-offline'], function (exports, _iISProektInvoiceOffline, _iISProektDocumentOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _iISProektDocumentOffline.default.extend(_iISProektInvoiceOffline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-proekt-invoice', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-proekt-invoice', 'ember-app/serializers/i-i-s-proekt-document'], function (exports, _iISProektInvoice, _iISProektDocument) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _iISProektDocument.default.extend(_iISProektInvoice.Serializer, {
    /**
    * Field name where object identifier is kept.
    */
    primaryKey: '__PrimaryKey'
...
define('ember-app/serializers/i-i-s-proekt-order-item-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-proekt-order-item-offline', 'ember-app/serializers/application-offline'], function (exports, _iISProektOrderItemOffline, _applicationOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _applicationOffline.default.extend(_iISProektOrderItemOffline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-proekt-order-item', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-proekt-order-item', 'ember-app/serializers/application'], function (exports, _iISProektOrderItem, _application) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _application.default.extend(_iISProektOrderItem.Serializer, {
    /**
    * Field name where object identifier is kept.
    */
    primaryKey: '__PrimaryKey'
...
define('ember-app/serializers/i-i-s-proekt-order-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-proekt-order-offline', 'ember-app/serializers/i-i-s-proekt-document-offline'], function (exports, _iISProektOrderOffline, _iISProektDocumentOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _iISProektDocumentOffline.default.extend(_iISProektOrderOffline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-proekt-order', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-proekt-order', 'ember-app/serializers/i-i-s-proekt-document'], function (exports, _iISProektOrder, _iISProektDocument) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _iISProektDocument.default.extend(_iISProektOrder.Serializer, {
    /**
    * Field name where object identifier is kept.
    */
    primaryKey: '__PrimaryKey'
...
define('ember-app/serializers/i-i-s-proekt-product-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-proekt-product-offline', 'ember-app/serializers/application-offline'], function (exports, _iISProektProductOffline, _applicationOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _applicationOffline.default.extend(_iISProektProductOffline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-proekt-product', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-proekt-product', 'ember-app/serializers/application'], function (exports, _iISProektProduct, _application) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _application.default.extend(_iISProektProduct.Serializer, {
    /**
    * Field name where object identifier is kept.
    */
    primaryKey: '__PrimaryKey'
...
define('ember-app/serializers/i-i-s-proekt-store-product-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-proekt-store-product-offline', 'ember-app/serializers/application-offline'], function (exports, _iISProektStoreProductOffline, _applicationOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _applicationOffline.default.extend(_iISProektStoreProductOffline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-proekt-store-product', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-proekt-store-product', 'ember-app/serializers/application'], function (exports, _iISProektStoreProduct, _application) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _application.default.extend(_iISProektStoreProduct.Serializer, {
    /**
    * Field name where object identifier is kept.
    */
    primaryKey: '__PrimaryKey'
...
define('ember-app/serializers/i-i-s-proekt-storehouse-offline', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-proekt-storehouse-offline', 'ember-app/serializers/application-offline'], function (exports, _iISProektStorehouseOffline, _applicationOffline) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _applicationOffline.default.extend(_iISProektStorehouseOffline.OfflineSerializer, {});
});
define('ember-app/serializers/i-i-s-proekt-storehouse', ['exports', 'ember-app/mixins/regenerated/serializers/i-i-s-proekt-storehouse', 'ember-app/serializers/application'], function (exports, _iISProektStorehouse, _application) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = _application.default.extend(_iISProektStorehouse.Serializer, {
    /**
    * Field name where object identifier is kept.
    */
    primaryKey: '__PrimaryKey'
  ...
  exports.default = _offlineGlobals.default.extend({
    ...
    getOfflineSchema: function getOfflineSchema() {
      ...
      var returnedSchema = Ember.merge(parentSchema, {
        'i-i-s-proekt-document': 'id,createDate,number',
        'i-i-s-proekt-employee': 'id,email,firstName,lastName,middleName,number,phoneNumber,position',
        'i-i-s-proekt-invoice-item': 'id,amount,price,totalSum,weight,product,invoice',
        'i-i-s-proekt-invoice': 'id,customerName,note,shipmentDateTime,status,totalSum,totalWeight,employee,order,*invoiceItem',
        'i-i-s-proekt-order-item': 'id,amount,priceWTaxes,totalSum,product,order',
        'i-i-s-proekt-order': 'id,paymentDate,shipmentDate,status,totalSum,employee,*orderItem',
        'i-i-s-proekt-product': 'id,description,measure,name,price,productCode,weight',
        'i-i-s-proekt-store-product': 'id,amount,product,storehouse',
        'i-i-s-proekt-storehouse': 'id,address,number,employee,*storeProduct'
      });
...
define('ember-app/transforms/i-i-s-proekt-invoice-status', ['exports', 'ember-flexberry-data/transforms/flexberry-enum', 'ember-app/enums/i-i-s-proekt-invoice-status'], function (exports, _flexberryEnum, _iISProektInvoiceStatus) {
  'use strict';
  ...
  exports.default = _flexberryEnum.default.extend({
    enum: _iISProektInvoiceStatus.default,
    sourceType: 'IIS.Proekt.InvoiceStatus'
  });
});
define('ember-app/transforms/i-i-s-proekt-order-status', ['exports', 'ember-flexberry-data/transforms/flexberry-enum', 'ember-app/enums/i-i-s-proekt-order-status'], function (exports, _flexberryEnum, _iISProektOrderStatus) {
  'use strict';
  ...
  exports.default = _flexberryEnum.default.extend({
    enum: _iISProektOrderStatus.default,
    sourceType: 'IIS.Proekt.OrderStatus'
  });
});
define('ember-app/transforms/i-i-s-proekt-position-list', ['exports', 'ember-flexberry-data/transforms/flexberry-enum', 'ember-app/enums/i-i-s-proekt-position-list'], function (exports, _flexberryEnum, _iISProektPositionList) {
  'use strict';
  ...
  exports.default = _flexberryEnum.default.extend({
    enum: _iISProektPositionList.default,
