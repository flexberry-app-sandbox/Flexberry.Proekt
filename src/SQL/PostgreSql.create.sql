...
CREATE INDEX Index956de1376853dbd72c90b4fc77b34a1065a7b353 on InvoiceItem (Invoice_m0); 
 ...
 ALTER TABLE Invoice ADD CONSTRAINT FK0ab43c8efc55c35a12aee09d4c3978af1799d1c0 FOREIGN KEY (Employee_m0) REFERENCES Employee; 
CREATE INDEX Index0ab43c8efc55c35a12aee09d4c3978af1799d1c0 on Invoice (Employee_m0); 
...
CREATE INDEX Indexef621d158f537998a10cc64f9edd24b3f8e864c3 on Invoice (Order_m0); 
 ...
 ALTER TABLE "Order" ADD CONSTRAINT FK1286c9bc6793871950a919c2e32a12a2d7d0b8c6 FOREIGN KEY (Employee_m0) REFERENCES Employee; 
CREATE INDEX Index1286c9bc6793871950a919c2e32a12a2d7d0b8c6 on "Order" (Employee_m0); 
...
CREATE INDEX Indexff800bd0bec1ed8a9fe70239b2d0fc6ef9f2bc4c on OrderItem (Order_m0); 
 ...
 ALTER TABLE Storehouse ADD CONSTRAINT FK04dd87712b01c0e42b0681b4c585c429bd39fc43 FOREIGN KEY (Employee_m0) REFERENCES Employee; 
CREATE INDEX Index04dd87712b01c0e42b0681b4c585c429bd39fc43 on Storehouse (Employee_m0); 
