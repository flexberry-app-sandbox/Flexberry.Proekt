...
(
	...
	"ShipmentDateTime" tDateTime NULL,
...
(
	...
	"ShipmentDate" tDateTime NULL,

	"PaymentDate" tDateTime NULL,
...
ALTER TABLE "Invoice"
	ADD CONSTRAINT "Invoice_FEmployee_0" FOREIGN KEY ("Employee_m0") REFERENCES "Employee" ("primaryKey");

CREATE INDEX "Invoice_IEmployee_m0" on "Invoice" ("Employee_m0");
...
ALTER TABLE "Order"
	ADD CONSTRAINT "Order_FEmployee_0" FOREIGN KEY ("Employee_m0") REFERENCES "Employee" ("primaryKey");

CREATE INDEX "Order_IEmployee_m0" on "Order" ("Employee_m0");
...
ALTER TABLE "Storehouse"
	ADD CONSTRAINT "Storehouse_FEmployee_0" FOREIGN KEY ("Employee_m0") REFERENCES "Employee" ("primaryKey");

CREATE INDEX "Storehouse_IEmployee_m0" on "Storehouse" ("Employee_m0");
